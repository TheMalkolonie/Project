...
<div class="container">
 ...
 mysql_query("UPDATE administrator SET Voornaam='$Voornaam', Tussenvoegsel='$Tussenvoegsel', Achternaam='$Achternaam', Straat='$Straat', Huisnummer='$Huisnummer' Postcode='$Postcode', Telefoonnummer='$Telefoonnummer', Email='$Email', Gebruikersnaam='$Gebruikersnaam' WHERE ID='$ID'")
 or die(mysql_error()); 
 ...
 $ID = $_GET['ID'];
 $result = mysql_query("SELECT * FROM administrator WHERE ID=$ID")
 or die(mysql_error()); 
