...
<?php include('clockblack.php'); ?>
  ...
  echo "<center><tr> <th>Product Code</th> <th>Catagorie</th> <th>Naam</th> <th>Product Afbeelding</th> <th>Product Beschrijving</th> <th>Prijs</th> <th></th> <th></th></tr></center>";
  ...
  if (strlen($msg) > 100) {
    ...
    echo '<td>' . $row['Naam'] . '</td>';
    echo "<td><img src='images/2".$row['Product_Afbeelding']."'><center>$row[Product_Afbeelding]</center>";
    echo $msg;
