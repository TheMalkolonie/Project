...
<body>
      ...
      <div class="container">
         <form class="form-signin" method="POST" action="management.php">
            ...
            <br />
            <div>
            <input class="btn btn-large btn-primary" type="" value="Bezoekers aantal" onclick="location.href = 'http://localhost/pizzaenco/teller.php';" />
            </div>
            <br />
             <div>
            <input class="btn btn-large btn-primary" type="" value="Review beheer" onclick="location.href = 'http://localhost/pizzaenco/error.php';" />
            </div>
            <br />
             <div>
            <input class="btn btn-large btn-primary" type="" value="Contact verzoeken" onclick="location.href = 'http://localhost/pizzaenco/error.php';" />
            </div>
            <br />             
         </form>
      </div>
