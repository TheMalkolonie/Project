...
if (isset($_POST['submit']))
{
   ...
   if($Email == $Email2 && $Wachtwoord == $Wachtwoord2)
 {
   ...
   $check = mysql_query("SELECT * FROM administrator WHERE Gebruikersnaam = '$Gebruikersnaam'")or die(mysql_error());
...
$form = <<<EOT
      ...
      <div class="container">
         <form class="form-signin" method="POST" action="bregister.php">
            <h2>Beheerder registreren:</h2>
            <br />
            ...
            <input class="btn btn-large btn-primary" type="button" value="Ga terug" onclick="location.href = 'http://localhost/pizzaenco/cbeheerder.php';" />
