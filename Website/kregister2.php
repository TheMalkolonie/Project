...
if (isset($_POST['submit']))
{
   ...
   if($Email == $Email2 && $Wachtwoord == $Wachtwoord2)
 {
  ...
  header('Refresh: 3;url=kregister2.php');
 }
...
$form = <<<EOT
      ...
      <div class="container">
         <form class="form-signin" method="POST" action="kregister2.php">
            ...
            <input class="btn btn-large btn-primary" type="button" value="Ga terug" onclick="location.href = 'http://localhost/pizzaenco/klogin.php';" />
